export const PAGE_TITLE = {
	...
	favorites: {
		...
		subtitle: 'Ваша персональна колекція страв і продуктів',
		description:
	...
	menus: {
		title: 'Меню',
		subtitle: 'Ваші збережені плани харчування',
		description:
			'Переглядайте та керуйте своїми збереженими меню. Особисті плани харчування та меню, якими поділилися з вами.',
		keywords: [
			'меню',
			'збережені меню',
			'плани харчування',
